...
contextBridge.exposeInMainWorld('editorAPI',{
 ...
 getSettings:()=>ipcRenderer.invoke('settings:get'),saveSettings:value=>ipcRenderer.invoke('settings:save',value),browseEngine:kind=>ipcRenderer.invoke('settings:browse',kind),testOpenAI:()=>ipcRenderer.invoke('settings:test-openai'),
