...
export const TransitionRegistry:RegistryItem[]=[
 ...
 {id:'push',name:'Push',category:'Slide',description:'Outgoing frame pushes the incoming frame.',parameters:[number('direction','Direction',-1,-1,1,2)],compatibility:['video']},
