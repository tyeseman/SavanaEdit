import { Bot, Clapperboard, FileAudio, Captions, WandSparkles, BetweenHorizontalEnd } from 'lucide-react';
import { useEditorStore, type EditorPanel } from '../../stores/editorStore';
const entries = [[Clapperboard,'Media'],[Bot,'Assistant'],[Captions,'Transcripts'],[WandSparkles,'Effects'],[BetweenHorizontalEnd,'Transitions'],[FileAudio,'Audio']] as const;
